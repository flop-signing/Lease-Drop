package com.bedatasolutions.leaseDrop.services.reports.tools.reports;//package com.itbd.docreader.service.reports;
//
...
//        btnPrint = new Button(null, new ImageView("assets/icon/report/printer.png"));
//        btnSave = new Button(null, new ImageView("assets/icon/report/save.png"));
//        btnBackPage = new Button(null, new ImageView("assets/icon/report/backimg.png"));
//        btnFirstPage = new Button(null, new ImageView("assets/icon/report/firstimg.png"));
//        btnNextPage = new Button(null, new ImageView("assets/icon/report/nextimg.png"));
//        btnLastPage = new Button(null, new ImageView("assets/icon/report/lastimg.png"));
//        btnZoomIn = new Button(null, new ImageView("assets/icon/report/zoomin.png"));
//        btnZoomOut = new Button(null, new ImageView("assets/icon/report/zoomout.png"));
//
